...
Matcher = (function() {
  ...
  Matcher.prototype.match = function(request) {
    var body, chunks, data, headers, method, name, path, url, value, _i, _len, _ref;
    url = request.url, path = request.path, method = request.method, headers = request.headers, body = request.body;
